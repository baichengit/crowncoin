...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    // Crowncoin: if user OS account compromised prevent trivial sendmoney commands
    if (params.size() > 2)
...
// Crowncoin: reserve balance from being staked for network protection
...
// Crowncoin: check wallet integrity
...
// Crowncoin: make a public-private key pair
