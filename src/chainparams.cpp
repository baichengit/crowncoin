...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        unsigned int nGenesisTime = 1456934400;
...
#endif
        assert(hashGenesisBlock == uint256("0000688f011b8acdbf1ae233f625483aad5d68ea176a6da287da2f8f40d8ef6c"));
        assert(genesis.hashMerkleRoot == uint256("1987800193829cd5b699053e5258bafeb9452f1e39e16110206ddbc583477c03"));

        //add dnsseed
        char *seeds[][2] ={

            "47.88.7.118","47.88.7.118",
            "1121.40.30.196","121.40.30.196",
            "120.27.125.170","120.27.125.170"
                          };
