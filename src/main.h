...
static const int64_t MAX_MONEY = 78000000 * COIN;
...
public:
    ...
    {
        // Crowncoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Crowncoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Crowncoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Crowncoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Crowncoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Crowncoin: block index flags
    enum  
    {
